  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.onTabCreated = function onTabCreated(item) {
      ...
      $__default["default"](SELECTOR_TAB_NAVBAR_NAV).append(unescape(escape(newNavItem)));
          ...
          /*****************************/
          var myurl= "/Country/test?id=" + 'reza nabiloo';
          //console.log(myurl);
          //console.log(uniqueName)
          
          myurl = uniqueName.replaceAll('-', '/');
          
          $.ajax({
              cache: false,
              type: "GET",
              url: myurl,//"/Country/Index",
              dataType: "html",              
              ...
              complete: function responce() {                  
                  var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><div>" + myContent + "</div></div>";
                  $__default["default"](SELECTOR_TAB_CONTENT).append(newTabItem);
                 // newTabItem.SELECTOR_DATA_TOGGLE_FULLSCREEN();
          ...
          var RezaContent = myContent; //"<h1>" + myTabId + "</h1>"
          //var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><div>"+RezaContent+"</div></div>";
          //  $__default["default"](SELECTOR_TAB_CONTENT).append(unescape(escape(newTabItem)));

          //$__default["default"](SELECTOR_TAB_CONTENT).append('<h1>Reza Nabiloo</h1>');
    ...
    _proto._fixHeight = function _fixHeight(tabEmpty) {
      ...
      if ($__default["default"]('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
        var windowHeight = $__default["default"](window).height();
          ...
          var footerHeight = $__default["default"](SELECTOR_FOOTER).outerHeight();
          
          $__default["default"](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING + ", " + SELECTOR_CONTENT_IFRAME).height(windowHeight - navbarHeight - footerHeight);
        $__default["default"](SELECTOR_CONTENT_WRAPPER).height(windowHeight);
      } else {
        var contentWrapperHeight = parseFloat($__default["default"](SELECTOR_CONTENT_WRAPPER).css('height'));

          var _navbarHeight = $__default["default"](SELECTOR_TAB_NAV).outerHeight();
          var _footerHeight = $__default["default"](SELECTOR_FOOTER).outerHeight();
          //console.log(_navbarHeight);
        if (tabEmpty == true) {
            setTimeout(function () {              
                $__default["default"](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING).height(contentWrapperHeight - _navbarHeight - _footerHeight);
          }, 50);
        } else {
...
function createChildTab(title, link, uniqueName, autoOpen, allowDuplicate) {
    ...
    if ($("#" + navId).length == 0) {                
        navId = navId.replaceAll("/", "-")
        tabId = tabId.replaceAll('/', '-');
        var navItem = "<li class=\"nav-item\" role=\"presentation\"><a href=\"#\" class=\"btn-iframe-close\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a></li>";
        $("[role=tablist]").append(unescape(escape(navItem)));
        childTabContent(link, tabId, navId)
    }
    else
    {
        $(".tab-pane").each(function () {
        ...
        $("[role=tablist] .nav-item").each(function () {
        ...
        $('#' + navId).children('.nav-link').addClass('active');
    }
};

function childTabContent(link, tabId, navId)
{
    var childContect = 'Reza nabiloo';
    $.ajax({
        cache: false,
        type: "GET",
        url: link,
        ...
        error: function (xhr, ajaxOptions, thrownError) {
            childContect = "<h1> خطا </h1>"
        },
        complete: function responce() {
            var tabContent = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><div>" + childContect + "</div></div>";
