                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var e = void 0,
                                        t = void 0;
                                    return (
                                        "string" == typeof arguments[0] ? ((e = arguments[0]), (t = arguments[1])) : ((t = arguments[0]), (e = arguments[1])),
                                        n.year.indexOf(e) > -1
                                            ? (e = "year")
                                            : n.month.indexOf(e) > -1
                                                ? (e = "month")
                            ...
                            [
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        else if (n.isArray(e)) this.algorithmsCalc([e[0], e[1] ? e[1] : 1, e[2] ? e[2] : 1, e[3], e[4], e[5], e[6] ? e[6] : 0]);
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        return (
                                            this.isPersianDate(e) && (e = [e.year(), e.month(), e.date(), e.hour(), e.minute(), e.second(), e.millisecond()]),
                                            "persian" === this.calendarType && "algorithmic" == this.leapYearMode
                                                ? this.algorithms.calcPersian(e)
                                                : "persian" === this.calendarType && "astronomical" == this.leapYearMode
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            "_default" === this.formatPersian
                                                ? (t = void 0 !== e && void 0 !== e.exports ? a.formatPersian !== !1 : window.formatPersian !== !1)
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        var a = this,
                                            ...
                                            r = { year: a.year(), month: a.month(), hour: a.hours(), minute: a.minutes(), second: a.seconds(), date: a.date(), timezone: a.zone(), unix: a.unix() },
                                            n = a.formatNumber(),
                                            s = function (e) {
                                                return n ? u(e) : e;
                                            };
                            ...
                            },
                            {
                                ...
                                value: function (e, t, a) {
                                    return (
                                        ...
                                        -Math.floor((e - 1) / 100) +
                                        Math.floor((e - 1) / 400) +
                                        Math.floor((367 * t - 362) / 12 + (t <= 2 ? 0 : this.leap_gregorian(e) ? -1 : -2) + a)
                                    );
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        ...
                                        1029982 === s ? (o = 2820) : ((h = Math.floor(s / 366)), (u = this.ASTRO.mod(s, 366)), (o = Math.floor((2134 * h + 2816 * u + 2815) / 1028522) + h + 1)),
                                        (t = o + 2820 * n + 474),
                                        t <= 0 && t--,
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    (t = this.ON.gregorian.year),
                                        ...
                                        (e = this.gregorian_to_jd(t, a + 1, i) + Math.floor(s + 60 * (n + 60 * r) + 0.5) / 86400),
                                        (this.ON.julianday = e),
                    ...
                    function e() {
                        i(this, e),
                            ...
                            (this.JDE0tab1000 = [
                                ...
                                new Array(1721233.25401, 365241.72562, -0.05323, 0.00907, 25e-5),
                                new Array(1721325.70455, 365242.49558, -0.11677, -0.00297, 74e-5),
                                new Array(1721414.39987, 365242.88257, -0.00769, -0.00933, -6e-5),
                            ]),
                            (this.JDE0tab2000 = [
                                new Array(2451623.80984, 365242.37404, 0.05169, -0.00411, -57e-5),
                                new Array(2451716.56767, 365241.62603, 0.00325, 0.00888, -3e-4),
                                new Array(2451810.21715, 365242.01767, -0.11575, 0.00337, 78e-5),
                                new Array(2451900.05952, 365242.74049, -0.06223, -0.00823, 32e-5),
                            ]);
                    }
                    return (
                        r(e, [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    for (
                                        s = u * (n = u * u),
                                        d[0] = this.dtr(297.850363 + 445267.11148 * u - 0.0019142 * n + s / 189474),
                                        d[1] = this.dtr(357.52772 + 35999.05034 * u - 1603e-7 * n - s / 3e5),
                                        d[2] = this.dtr(134.96298 + 477198.867398 * u + 0.0086972 * n + s / 56250),
                                        d[3] = this.dtr(93.27191 + 483202.017538 * u - 0.0036825 * n + s / 327270),
                                        d[4] = this.dtr(125.04452 - 1934.136261 * u + 0.0020708 * n + s / 45e4),
                                        i = 0;
                                        i < 5;
                                        i++
                                    )
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        e >= 1620 && e <= 2e3
                                            ? ((i = Math.floor((e - 1620) / 2)), (a = (e - 1620) / 2 - i), (t = this.deltaTtab[i] + (this.deltaTtab[i + 1] - this.deltaTtab[i]) * a))
                                            : ((r = (e - 2e3) / 100), e < 948 ? (t = 2177 + 497 * r + 44.1 * r * r) : ((t = 102 + 102 * r + 25.3 * r * r), e > 2e3 && e < 2100 && (t += 0.37 * (e - 2100)))),
                                        t
                                    );
                                },
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var a = void 0,
                                        ...
                                        d = void 0;
                                    for (
                                        e < 1e3 ? ((s = this.JDE0tab1000), (d = e / 1e3)) : ((s = this.JDE0tab2000), (d = (e - 2e3) / 1e3)),
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        ...
                                        (s = (1.914602 + -0.004817 * t + -14e-6 * a) * this.dsin(r) + (0.019993 - 101e-6 * t) * this.dsin(2 * r) + 289e-6 * this.dsin(3 * r)),
                                        (o = i + s),
                                        (h = r + s),
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return (
                                        ...
                                        (n = 280.4664567 + 360007.6982779 * s + 0.03032028 * s * s + (s * s * s) / 49931 + -(s * s * s * s) / 15300 + -(s * s * s * s * s) / 2e6),
                                        (n = this.fixangle(n)),
                                        (t = this.sunpos(e)[10]),
                                        (a = this.nutation(e)[0]),
        ...
        function (e, t, a) {
            ...
            var r = function e() {
                i(this, e),
                    ...
                    (this.zone = 0),
                    (this.gregorian = { year: 0, month: 0, day: 0, hour: 0, minute: 0, second: 0, millisecond: 0, weekday: 0, unix: 0, leap: 0 }),
                    (this.juliancalendar = { year: 0, month: 0, day: 0, leap: 0, weekday: 0 }),
                    (this.islamic = { year: 0, month: 0, day: 0, leap: 0, weekday: 0 }),
                    (this.persianAlgo = this.persian = { year: 0, month: 0, day: 0, leap: 0, weekday: 0 }),
                    (this.persianAstro = { year: 0, month: 0, day: 0, leap: 0, weekday: 0 }),
